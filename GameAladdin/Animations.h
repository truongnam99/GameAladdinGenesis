...
public:
	...
	DWORD GetLastFrameTime() { return lastFrameTime; }
	void SetLastFrameTime(DWORD time) { this->lastFrameTime = time; };
	int GetFlagReverse() { return flagReverse; }
	void SetFlagReverse(int i) { this->flagReverse = i; }
	~Animation();
};
